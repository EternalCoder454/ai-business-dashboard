...
/**
 * The Company Profile, as a panel of Settings rather than a screen of its own.
 *
 * It was its own page and its own link in the account menu, next to Settings,
 * which meant the two places a business is configured were two places. The
 * content is unchanged; what left is the page header and the scrolling, both of
 * which the tab it now sits in provides.
 */
