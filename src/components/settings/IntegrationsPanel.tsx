...
export function IntegrationsPanel() {
  ...
  return (
    <div className="flex flex-col gap-5">
      {/*
        * No page header: this is a tab of Settings now and the tab has one.
        *
        * The New key button lived in that header, so it leads the panel
        * instead rather than quietly disappearing with it.
        */}
      {admin ? (
