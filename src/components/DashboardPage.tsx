...
/**
 * The dashboard, with the two panes the server already filled in.
 *
 * A client component under a server one, rather than the whole page being a
 * client component as it was. The split exists so the recent conversations and
 * meetings can be read on the request that renders the HTML, instead of after
 * the browser has run the JavaScript and asked for the workspace.
 */
export function DashboardPage({ preview }: { preview: DashboardPreview | null }) {
