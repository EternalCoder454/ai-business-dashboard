...
function initAuth(config, onLazyLoad // To set the default env vars
    ...
    return (...args)=>{
        if (!args.length) {
            // React Server Components
            return Promise.resolve((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["headers"])()).then((h)=>getSession(h, config).then(parseSessionResponse));
        }
        if (args[0] instanceof Request) {
            // middleware.ts inline
            // export { auth as default } from "auth"
...
//# sourceMappingURL=node_modules_16yw46v._.js.map