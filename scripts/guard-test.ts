...
console.log("\na write immediately after a create can see it");
{
  const blank = emptyWorkspace(
    { model: "claude-sonnet-5", effort: "medium", theme: "dark", companyName: "T", companySubtitle: "", writingRules: "", roomBrevity: "tight", companyMark: "T", brand: "amber", density: "comfortable", sidebarSide: "left", searchShortcut: "slash", wikiTitle: "Internal Wiki", wikiSubtitle: "2 minute read" },
